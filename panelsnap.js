...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).PanelSnap =
        e());
})(this, function () {
  "use strict";
  function t(t, e) {
  ...
  var u = (function () {
    function t() {
      ...
      h(this, t),
        ...
        (this.tweener = e.tweener || new l(e)),
  ...
  function v(t, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
      ...
      s = o.top - r.top,
      a = o.left - r.left,
      l = n ? o.height - r.height : 0,
      c = i ? o.width - r.width : 0,
      h = f(t);
    return { top: s + l + h.scrollTop, left: a + c + h.scrollLeft };
  }
  var p = (function () {
      var t = !1;
      try {
  ...
  return (function () {
    function t(n) {
      ...
      (this.container = this.options.container),
        (this.scrollContainer = f(this.container)),
        (this.scrollEventContainer =
          (i = this.container) === document.body ? window : f(i)),
        (m += 1),
        (this.instanceIndex = m),
        (this.container.dataset.panelsnapId = this.instanceIndex);
      var r = '[data-panelsnap-id="'
        .concat(this.instanceIndex, '"] ')
        .concat(this.options.panelSelector);
      (this.panelList = Array.from(document.querySelectorAll(r))),
        (this.events = []),
        (this.isEnabled = !0),
    ...
    return (
      ...
      (o = [
        ...
        },
        {
          ...
          value: function (t, e) {
            var n = this.events[t] || [];
            (this.events[t] = [].concat(r(n), [e])),
              "activatePanel" === t && e.call(this, this.activePanel);
          },
        },
        {
          key: "off",
          ...
          value: function () {
            ...
            if (o.length > 1) {
              if (
                ...
                Math.abs(e) < this.options.directionThreshold &&
                this.activePanel
              )
                return void this.snapToPanel(this.activePanel, t > 0, e > 0);
              var s = t > 0 || e > 0 ? 1 : o.length - 2;
              this.snapToPanel(o[s], t < 0, e < 0);
            } else {
              var a = o[0];
              !(function (t, e) {
                var n = d(t),
                ...
                ? (console.error(
                  ...
                  this.snapToPanel(a, t > 0, e > 0))
                : this.activatePanel(a);
            }
          },
        },
        {
          ...
          value: function (t) {
            ...
            this.activatePanel(t),
              this.isEnabled &&
                ...
                (this.targetScrollOffset = v(this.container, t, n, i)),
